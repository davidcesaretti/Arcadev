      ...
      <div className="flex items-center justify-center w-full h-full bg-[#020408] gap-6 px-4 py-4 overflow-auto">
        ...
        <div
          ...
          style={{
            ...
            boxShadow:
              '0 0 28px rgba(0,255,231,0.1), inset 0 0 28px rgba(0,255,231,0.02)',
          }}
        >
          <canvas
            ref={canvasRef}
          ...
          {ui.phase === 'waiting' && (
            <div className="absolute inset-0 flex flex-col items-center justify-center bg-black/80 backdrop-blur-sm">
              <p
                className="font-arcade text-3xl font-bold tracking-widest mb-1"
                style={{
                  color: '#00ffe7',
                  textShadow: '0 0 20px #00ffe7, 0 0 40px #00ffe760',
                }}
              >
                SNAKE
              </p>
          ...
          {ui.phase === 'win' && (
            <div className="absolute inset-0 flex flex-col items-center justify-center bg-black/75 backdrop-blur-sm">
              ...
              <p
                className="font-arcade text-sm text-[#ffd700]"
        ...
        >
          ...
          {/* Velocidad activa */}
          <div
            className="border bg-[#060d18] p-3"
            style={{ borderColor: `${speedCfg.color}30` }}
          >
            <p className="font-arcade text-[8px] tracking-widest text-zinc-500 uppercase mb-1">
              Speed
            </p>
            <p
              ...
              style={{
                ...
                textShadow: `0 0 8px ${speedCfg.color}80`,
              }}
            >
              {speedCfg.label}
            </p>
            <p
              className="font-arcade text-[8px] tracking-widest mt-1"
              style={{ color: `${speedCfg.color}80` }}
            >
            ...
            <div className="flex flex-col gap-1">
              {SPEED_ORDER.map((tier, i) => {
                ...
                return (
                  ...
                  >
                    <span
                      className="font-arcade text-[7px] flex-shrink-0"
